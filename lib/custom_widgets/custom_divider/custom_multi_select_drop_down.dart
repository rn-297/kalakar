...
class CustomDropdownSearch2 extends StatelessWidget {
  final String? Function(List<String>?)? validator;
  final List<String> items;
  final double borderRadius;
  final String labelText;
  final String titleText;
   List<String> selectedItems=[]; // Now a list to handle multiple selections
    ...
    return DropdownSearch<String>.multiSelection( // Multi-selection enabled
      ...
      decoratorProps: DropDownDecoratorProps(
        ...
        decoration: InputDecoration(
          ...
          labelText: labelText,
          labelStyle: TextStyle(color: textColor, fontSize: 12.sp),
