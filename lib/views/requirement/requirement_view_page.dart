        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              rowDataToShow(
                  "Shooting End Date : ", formatter.format(shootingEndDate)),
              Row(
                children: [
                  Expanded(
                    child: rowDataToShow(
                  ...
                  Expanded(
                    child: rowDataToShow("Gender : ", requirement.gender!),
                  )
                ],
              ),
              Row(
                children: [
                  Expanded(
                    child: rowDataToShow("Height : ", requirement.height!),
                  ),
                  Expanded(
                    child: rowDataToShow("Weight : ", requirement.weight!),
                  )
                ],
              ),
              ...
              rowDataToShow("Comfortable In : ", requirement.comfortableIn!),
              rowDataToShow(
                  "Script For Audition : ", requirement.scriptForAuditions!),
