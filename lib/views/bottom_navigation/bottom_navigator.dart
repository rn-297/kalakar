...
class BottomNavigatorPage extends StatelessWidget {
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 110.h,child: Center(child: Image.asset("assets/images/app_logo2.PNG",fit: BoxFit.cover,)),), // Empty space above first item
                      customNavItem(KalakarConstants.home, 0, navigationController),
                      customNavItem(KalakarConstants.opportunities, 1, navigationController),
                      customNavItem(KalakarConstants.profile, 2, navigationController),
                      customNavItem(KalakarConstants.settings, 3, navigationController),
                    ],
                  ),
                ),
  ...
  Widget customNavItem(String label, int index, BottomNavigationController navigationController) {
