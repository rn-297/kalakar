                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: KalakarColors.appBarBackground1,
                              border:
                                  Border.all(color: KalakarColors.headerText),
                              boxShadow: [
                                BoxShadow(
                                  color: Colors.grey,
                                  blurRadius: 3.0,
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Container(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          controller
                                              .setReviewDataToView(reviewData);
                                        },
                                        child: Row(
                                          crossAxisAlignment:
                                              CrossAxisAlignment.center,
