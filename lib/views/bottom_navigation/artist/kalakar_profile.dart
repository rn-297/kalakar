                            ...
                            controller.isArtistProfileEducationLoading
                                ...
                                : controller.artistEducationList.isNotEmpty
                                    ? ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: controller
                                            .artistEducationList.length,
                                        physics: NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          EducationList educationData =
                                              controller
                                                  .artistEducationList[index];
                                          DateTime courseEndDate =
                                              DateTime.parse(educationData
                                                  .courseEndDate
                                                  .toString());
                            ...
                            controller.isArtistProfileComfortableInLoading
                                ...
                                : controller.artistComfortableInList.isNotEmpty
                                    ? ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: controller
                                            .artistComfortableInList.length,
                                        physics: NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                    ...
                                    : Center(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                "Unable To Get Comforatble In Data"),
                                            SizedBox(
                                              height: 16.h,
                                            ),
                                            InkWell(
                            ...
                            controller.isArtistProfileHobbiesLoading
                                ...
                                : controller.artistHobbiesList.isNotEmpty
                                    ? ListView.builder(
                                        ...
                                        physics: NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          HobbiesList hobbiesData = controller
                                              .artistHobbiesList[index];
                                          return Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
                            ...
                            controller.isArtistProfileInterestedInLoading
                                ...
                                : controller.artistInterestedInList.isNotEmpty
                                    ? ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: controller
                                            .artistInterestedInList.length,
                                        physics: NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          InterestList interestInData =
                                              controller.artistInterestedInList[
                                                  index];
                                          return Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                    ...
                                    : Center(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                "Unable To Get Interested In Data"),
                                            SizedBox(
                                              height: 16.h,
                                            ),
                                            InkWell(
                            ...
                            controller.isArtistProfileApplyForLoading
                                ...
                                : controller.artistApplyForList.isNotEmpty
                                    ? ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: controller
                                            .artistApplyForList.length,
                                        physics: NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          ApplyList applyForData = controller
                                              .artistApplyForList[index];
                                          return Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
