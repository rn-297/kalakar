  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ScreenTypeLayout.builder(
        mobile: (BuildContext context) => appliedProfilesMobileView(context),
        tablet: (BuildContext context) => appliedProfilesWebView(context),
      ),
    );
  }
...
*/
  ...
  appliedProfilesMobileView(BuildContext context) {
  ...
  appliedProfilesWebView(BuildContext context) {
    return GetBuilder<RequirementController>(builder: (controller) {
      DateTime completedDate = DateTime.parse(
          controller.selectedRequirement.shootingEndDate.toString());
