  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ScreenTypeLayout.builder(
        mobile: (BuildContext context) => companyMoreInfoMobileView(),
        tablet: (BuildContext context) => companyMoreInfoWebView(),
      ),
    );
  }

  companyMoreInfoMobileView() {
        ...
        child: GetBuilder<ProfileController>(builder: (controller) {
          return Column(
            children: [
              ...
              CommonWidgets.commonMobileTextField(
                  controller: controller.filmCorporationCardTEController,
              ...
              CommonWidgets.commonMobileTextField(
                  controller: controller.addressProofOfCompanyTEController,
