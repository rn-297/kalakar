class ArtistAppliedRequirementDetailsClass {
  List<AppliedRequirementDetailsList>? objResponesRequirementDetailsList;
  bool? replayStatus;
  String? message;
  ...
  ArtistAppliedRequirementDetailsClass.fromJson(Map<String, dynamic> json) {
    if (json['objResponesRequirementDetailsList'] != null) {
      objResponesRequirementDetailsList = <AppliedRequirementDetailsList>[];
      json['objResponesRequirementDetailsList'].forEach((v) {
        objResponesRequirementDetailsList!
            .add(new AppliedRequirementDetailsList.fromJson(v));
      });
    }
...
class AppliedRequirementDetailsList {
  String? userID;
  String? artistUserID;
  ...
  AppliedRequirementDetailsList.fromJson(Map<String, dynamic> json) {
    userID = json['userID'];
